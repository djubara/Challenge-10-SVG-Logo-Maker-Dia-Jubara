//reference for array of colors: https://www.w3schools.com/colors/colors_names.asp
// Path: assets/w3Colors.js

const w3sColors = ['aliceblue', 'antiquewhite', 'aqua', 'aquamarine', 'azure', 'beige', 'bisque', 'black', 'blanchedalmond', 'blue',
